...
export default class ApiService {
    ...
    static async updateUserProfile(userId, updates) {
        const response = await axios.put(`${this.BASE_URL}/users/update-profile/${userId}`, updates, {
            headers: this.getHeader()
        })
        return response.data
    }
    ...
    static async chatWithBot(message) {
        const response = await axios.post(`${this.BASE_URL}/chatbot/chat`, 
            { message }, 
            { headers: this.getHeader() }
        )
        return response.data
    ...
    static async getWallet() {
        const response = await axios.get(`${this.BASE_URL}/wallet/balance`, {
            headers: this.getHeader()
        })
        return response.data
    }
    ...
    /* Add money to wallet */
    static async addMoneyToWallet(amount, paymentMethod) {
        const response = await axios.post(`${this.BASE_URL}/wallet/add`, 
    ...
    /* Spend money from wallet for booking */
    static async spendFromWallet(amount, bookingId, description) {
        const response = await axios.post(`${this.BASE_URL}/wallet/spend`, 
    ...
    static async getWalletTransactions() {
        const response = await axios.get(`${this.BASE_URL}/wallet/transactions`, {
            headers: this.getHeader()
        })
        return response.data
    }
    ...
    static async refundToWallet(amount, bookingId, reason) {
        const response = await axios.post(`${this.BASE_URL}/wallet/refund`, 
